...
const last100Elements = factorydata.sensor_data.slice(-100);
const chartData = last100Elements.map(({ sid,Load,Power, Pressure,Flow }) => {
  return {
    sid: sid,
    Load: Load,
    Power: Power,
...
factorydata.sensor_data.forEach(obj => {
  cnt+=1;
  if(obj.Power> 105){
